...
function M.on_attach(client, bufnr)
  ...
  buf_set_keymap('i', '<Plug>(ide-show-signature-help)', '<cmd>lua vim.lsp.buf.signature_help()<CR>', opts)
  buf_set_keymap('n', '<space>wa', '<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>', opts)
  buf_set_keymap('n', '<space>wr', '<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>', opts)
  buf_set_keymap('n', '<space>wl', '<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>', opts)
  buf_set_keymap('n', '<Plug>(ide-list-workspace-symbols)', '<cmd>lua vim.lsp.buf.workspace_symbol()<CR>', opts)
  buf_set_keymap('n', '<Plug>(ide-list-document-symbols)', '<cmd>lua vim.lsp.buf.document_symbol()<CR>', opts)
  ...
  buf_set_keymap('n', '<Plug>(ide-diagnostic-info)', '<cmd>lua vim.diagnostic.open_float()<CR>', opts)
