...
function M.on_attach(client, bufnr)
  ...
  buf_set_keymap('n', '<Plug>(ide-workspace-symbols)', '<cmd>lua vim.lsp.buf.workspace_symbol()<CR>', opts)
  buf_set_keymap('n', '<Plug>(ide-document-symbol)', '<cmd>lua vim.lsp.buf.document_symbol()<CR>', opts)
