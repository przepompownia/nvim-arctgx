...
highlight IdeReferenceRead cterm=bold ctermbg=red guibg=#E6F4AA
highlight IdeReferenceText cterm=bold ctermbg=red guibg=#F4EDAA
highlight IdeReferenceWrite cterm=bold ctermbg=red guibg=#F4DBAA
